...
public class SysLoginController {
	...
	public R login(String username, String password, String captcha,String googleCode) {
		...
		if(user!=null) {
			if(googleCode==null||"".equals(googleCode.trim())) {
				  return R.error("请输入密令");
			}
			String savedSecret = user.getSecret(); //创建用户时生成的密钥
			if(savedSecret!=null&&!"".equals(savedSecret.trim())) {
